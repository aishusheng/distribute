...
public interface SayHelloServiceImpl {
    ...
    @RequestWrapper(localName = "sayHello", targetNamespace = "http://impl.service.chinalin.com/", className = "com.chinalin.client.SayHello")
    @ResponseWrapper(localName = "sayHelloResponse", targetNamespace = "http://impl.service.chinalin.com/", className = "com.chinalin.client.SayHelloResponse")
